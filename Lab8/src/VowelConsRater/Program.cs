...
namespace VowelConsRater
{
    class Program
    {
        ...
        private const string OUTPUT_EXCHANGE_NAME = "text-rank-calc";
        ...
        private static void AddRankToExchange(string contextId
                                                , float rank
                                                , IModel channel)
        {                    
            
            channel.ExchangeDeclare(exchange: OUTPUT_EXCHANGE_NAME, 
                                        type: "fanout");            
            string message = "TextRankCalculated:" + contextId + ":" + rank;
            Console.WriteLine("SEND: " + message + " to exch " + OUTPUT_EXCHANGE_NAME);
