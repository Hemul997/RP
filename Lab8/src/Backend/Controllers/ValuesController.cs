...
namespace Backend.Controllers
{
    ...
    public class ValuesController : Controller
    {
        ...
        private IActionResult GetRankFromDbById(string id, IDatabase redisDB)
        {
            ...
            {
                result = result = Ok("Превышен лимит проверок текста. Для неограниченной проверки текстов приобретите подписку.");//new NotFoundResult();
            }            
        ...
        {                                     
            ...
            string value = null;            
            value = redisDB.StringGet("statistics");
            return Ok(value);
        }
